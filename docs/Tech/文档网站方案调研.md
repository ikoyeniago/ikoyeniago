...
- [JAMStack](https://jamstackthemes.dev/)：JavaScript、APIs和Markup的首字母组合，本质上是一种胖前端，通过调用各种API来实现更多的功能，其实也是一种前后端的模式，只不过离得比较开，甚至前后端来自多个不同的厂商。通俗来说，JAMStack 就是使用SSG技术，并且不依赖Web服务的前端技术栈。
  - 特点：
    - 全站托管于CDN上
...
| ---------------------- | ------------------------------------------------------------ | ------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Sphinx                 | 基于Python支持reStructuredText和Markdown扩展丰富、可定制，拥有庞大的社区支持 | -             | https://www.sphinx-doc.org/                                  | 和Read the Docs捆绑：留观                                    |
| **Docusaurus**         | Facebook开发，基于ReactDocusaurus网站本身就是一个React应用。希望借由现代化JavaScript生态系统工具，在文档站点性能、资源构建系统，优化和易部署性等领域制定新标准。快速搭建、部署和维护文档网站，开发文档、技术文档、产品文档等默认文本格式为Markdown内置搜索、版本控制、多语言翻译支持，方便文档维护和更新网站具有响应式布局，让文档在不同设备上自适应显示，允许自定义主题、布局、字体等国内不少公司使用，例如声网 | 8.8k/58.3k    | https://docusaurus.io/https://github.com/facebook/docusaurus | [為什麼我選用 Docusaurus?](https://ouch1978.github.io/docs/docusaurus/intro/why-docusaurus)[官方SSG对比](https://docusaurus.io/zh-CN/docs/next#comparison-with-other-tools)专为文档设计、完全免费、 |
| **VuePress/VitePress** | 初衷是为了支持Vue.js及其子项目的文档需求，但已经被大量用于构建文档、博客和其他静态网站以Markdown为中心，专为技术文档设计VuePress，Vue2的官方文档构建工具，由Vue驱动的静态网站生成器，基于Webpack构建，支持多语言、多版本、搜索等功能。适合创建文档网站。VitePress，Vue3的官方文档构建器，由Vite和Vue驱动的静态站点生成器，基于Vite和Vue构建，在灵活性和可配置性上作出了一些让步，更轻更快但插件生态简单。适合创建小型文档网站或者单独文档页面。 | 4.8k/22.7k    | https://vuepress.vuejs.org/zh/https://github.com/vuejs/vuepress | [利用VitePress部署静态网站](https://www.cnblogs.com/itkkk/p/18184599)[我的自建博客之旅03之vuepress和Vitepress](https://juejin.cn/post/7347957960884437033)[vitepress这或许是开源系统中，最好用的开源文档工具了吧](https://cloud.tencent.com/developer/article/2439946)[VitePress + GitHub Pages 免费部署所有项目静态网站](https://juejin.cn/post/7157961507106471973)[遐思笔记——旧貌换新颜](https://alephpi.github.io/article/遐思笔记——旧貌换新颜)[VuePress升级成VitePress](https://juejin.cn/post/7021062842790969381)[VuePress和VitePress的区别](https://blog.csdn.net/qq_29669259/article/details/129712443)专为文档设计、 |
| **MkDocs**             | 基于Python专为项目文档设计，偏向文档生成不支持单页应用，也没有React等框架支持默认文本格式为Markdown配置文件格式为YAML可以轻松集成到各种CI/CD工作流程提供开发服务器，支持实时预览用户不是特别多，只有十几个主题，Material for MkDocs最经典 | 2.4k/19.9k    | http://www.mkdocs.org/https://github.com/mkdocs/mkdocs       | [MkDocs快速上手指南](https://pwa.sspai.com/prime/story/mkdocs-primer)[使用MkDocs和Material](https://zhuanlan.zhihu.com/p/672743170)[Mkdocs简介及实践](https://cloud.tencent.com/developer/article/2403351)[MkDocs+Material 国内搭建参考手册](https://robinyqc.cn/blogs/blogrepo/MkDocs 国内搭建参考手册)[Material for MkDocs](https://wdk-docs.github.io/mkdocs-material-docs/setup/changing-the-logo-and-icons/)不能搞炫酷主页：留观 |
| **Jekyll**             | 基于Ruby，模板语言为Liquid非常适合博客和项目文档默认文本格式为MarkdownGitHub Pages的默认生成器，容易与GitHub集成，提供了四百多种主题和两百多个插件满足定制需求静态生成 HTML，再通过 `<``script ``/>` 标签实现交互 | 10k/49.6k     | https://jekyllrb.com/https://github.com/jekyll/jekyll        | [Jekyll制作文档并发布到GitHub](https://cloud.tencent.com/developer/article/1459089)[官方快速入门](https://www.jekyll.com.cn/docs/)[Jekyll + GitHub Pages](https://blog.csdn.net/zzy979481894/article/details/132678717)[极简线上搭建个人网站](https://zhuanlan.zhihu.com/p/51240503)[Jekyll使用教程笔记1](https://juejin.cn/post/6844903623567081486)[Jekyll使用教程笔记2](https://juejin.cn/post/6844903629246169096) |
| Gatsby                 | 基于React和[GraphQL](https://juejin.cn/post/6844903475420069902)适合构建许多类型的网站，其中Docz是用于搭建文档网站的主题大多数静态网站其实并不需要GraphQL所提供的灵活性从Contentful/Drupal/WordPress等CMS、Documentation/Posts等Markdown、API/Databases/YAML/JSON/CSV等Data来源加载数据在构建过程中从多个GraphQL API取得数据，然后创建出一个全静态的无后端的React app | 10.3k/55.7k   | https://www.gatsbyjs.org/https://github.com/gatsbyjs/gatsby  | [Gatsby入门指南](https://juejin.cn/post/6844903999024398343)自己实现：留观 |
| Hugo                   | 基于Go构建速度快，支持Markdown和reStructuredText，具有丰富的主题和插件生态可以轻松处理大型项目，生成SEO友好的URL和网站结构 | 7.7k/78k      | https://gohugo.io/https://github.com/gohugoio/hugo           | [Hugo入门教程](https://juejin.cn/post/7114127835614150692)https://gohugo.io/getting-started/quick-start/大型项目：留观 |
| Rspress                | 用于创建优雅文档和静态网站，生成易于部署的静态HTML文件基于Rspack的快速静态站点生成器，一个基于Rust的捆绑器支持通过MDX（带有React组件的 Markdown） 写作，集成了文本搜索、多语言支持和插件扩展的特性Rspress建立不久，得益于现代基础设施，能够更快地实现站点构建；而Docusaurus则在成熟、全面的功能设置、灵活性和强大的社区方面有优势 | -             | -                                                            | 相对稚嫩：留观                                               |
| Next.js                | 一款React混合框架，可以构建出色的文档网站，但它并不着重于文档功能本身，而且需要手动实现Docusaurus所自带的功能Nextra是一款基于Next.js的静态站点生成器，功能比Docusaurus匮乏 | -             | -                                                            | 自己实现：留观                                               |
| Hexo                   | 快速、简洁且高效适合博客                                     | 4.9k/40k      | https://hexo.iohttps://github.com/hexojs/hexo                | [Hexo制作文档并发布到GitHub](https://cloud.tencent.com/developer/article/1460193?from_column=20421&from=20421)面向博客：pass |
| Docsify                | 基于Vue/JavaScript偏向于文档不是一款静态网站生成器，只有一个index.html，打开网页时实时将Markdown文件解析为HTML，无需预先构建静态HTML对搜索引擎不太友好 | 5.7k/28.8k    | https://docsify.js.org/https://github.com/docsifyjs/docsify  | 不是静态：pass                                               |
| Gitbook                | 只对开源和非营利团队免费重点逐渐从开源工具转向商业产品       | -             | -                                                            | [GitBook制作文档并发布到GitHub](https://cloud.tencent.com/developer/article/1460195?from_column=20421&from=20421)不免费：pass |
